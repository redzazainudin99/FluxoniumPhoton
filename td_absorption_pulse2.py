...
from photon_waveform_converter_bandpassCleaning import *
...
delay = Variable("delay",100*np.arange(50) + 10, "ns")
...
sequence.add(Acquire(len(reversed_photon)), readout_port,copy=False)
