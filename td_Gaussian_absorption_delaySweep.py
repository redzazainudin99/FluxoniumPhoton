...
digi_acquire = Acquire(duration = 20000)         #pulse input into digiitizer
# readout_acquire = Acquire(duration=15000)


gf_pi_flat.params['top_duration'] = 14000
...
revExp_sequence.add(Gaussian(amplitude=0.1, fwhm = 6000,  duration=14000),readout_port, copy=False )
