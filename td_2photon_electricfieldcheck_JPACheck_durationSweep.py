...
duration = Variable("duration",2000 + 1000 * np.arange(3), "ns")
...
data = DataDict(
        emission_length=dict(unit="ns"),
        time=dict(unit="ns"),
        waveform=dict(axes=["emission_length", "time"], unit="V"),
        wave_I=dict(axes=["emission_length", "time"], unit="V"),
        wave_Q=dict(axes=["emission_length", "time"], unit="V"),
        g_plus_e_I=dict(axes=["emission_length", "time"], unit="V"),
        g_minus_e_I=dict(axes=["emission_length", "time"], unit="V"),
        g_plus_e_Q=dict(axes=["emission_length", "time"], unit="V"),
        g_minus_e_Q=dict(axes=["emission_length", "time"], unit="V"),
    )
...
with DDH5Writer(data, data_path, name=measurement_name) as writer:
    ...
    for update_command in tqdm(variables.update_command_list):         
        ...
        writer.add_data(
                    emission_length=seq.variable_dict["duration"][0].value,
