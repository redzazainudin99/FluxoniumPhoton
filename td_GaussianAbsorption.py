...
gf_pi_flat.params['top_duration'] = 1500


delay = Variable("delay",10*np.arange(5) + 10, "ns")
...
revExp_sequence.add(Gaussian(amplitude=0.1, duration=2400),readout_port, copy=False )
revExp_sequence.add(Delay(delay),gf_drive_port)
...
points_per_cycle = 5000         #Add a Fourier transform in here somewhere, as it is the main thing to compare successful absorption
